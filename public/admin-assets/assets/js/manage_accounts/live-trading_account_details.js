$(function () {
    ...
    $(document).on("click", ".reset-password-btn", function () {
        ...
        Swal.fire({
            ...
            html:
                "Are you confirm to reset password of account <b>#" +
                $(this).data("accountno") +
                "</b>",
            showCancelButton: true,
            customClass: {
                ...
                $.ajax({
                    ...
                    success: function (inner_data) {
                        if (inner_data.status === true) {
                            ...
                            Swal.fire({
                                icon: "error",
                                title: "Unabel to reset password!",
...
$(document).on("click", ".btn-manage-fund", function () {
    ...
    $.ajax({
        ...
        success: function (data) {
            console.log(data);
            if (data.status == true) {
                $("#fund-trading_account").html(data.trading_account);
...
function createFundCallBack(data) {
    if (data.status == true) {
        ...
        let url =
            "/admin/finance/fund-management-email/" +
            data.account_id +
            "/credit/" +
            data.credit_id +
            "/transaction/" +
        ...
        send_mail(
            "Fund management",
            "Please wait while we sending email",
            url,
            true
        );
        $("#fund-add-form").trigger("reset");
    } else {
        notify("error", "Somthing went wrong please try again later!");
    }
