(function (window, document, $) {
    ...
    // -------------------------------------------------------------------------------
    function banner_datatable(banner_size) {
        ...
        return $('.banners-table-160-600').DataTable({
            ...
            "dom": 'B<"clear">lfrtip',
            "ajax": {
                "url": "/admin/settings/banner-datatable/"+banner_size,
            },
            "columns": [
                {
                    data: "banner_1",
    ...
    var table = banner_datatable('160x600');
    ...
    $(document).on("click",".tab-banner-link",function () {
        ...
        table.clear().destroy();
        table = banner_datatable(banner_size);
    })
