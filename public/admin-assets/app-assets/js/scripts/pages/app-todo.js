...
$(function () {
  var taskTitle,
    ...
    taskAssignSelect2 = $('#task-assigned_e'),
    taskTag = $('#task-tag'),
  ...
  if (taskAssignSelect2.length) {
    taskAssignSelect2.wrap('<div class="position-relative"></div>');
    taskAssignSelect2.select2({
      placeholder: 'Unassigned',
      dropdownParent: taskAssignSelect2.parent(),
      templateResult: assignTask,
      templateSelection: assignTask,
      escapeMarkup: function (es) {
        return es;
