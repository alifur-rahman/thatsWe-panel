...
(function (window, document, $) {
  ...
  // var assetPath = '../../../admin-assets/app-assets/';
    var assetPath =  window.location.origin+'/public/admin-assets/app-assets/';
      ...
      if (value != '') {
        ...
        var $startList = '',
          ...
          $pageList =
            ...
            '</a>' +
            '<a class="w-50 text-start" href="#">' +
            '<h6 class="section-label mt-75 mb-0">Group</h6>' +
            '</a>' +
            '</li>',
          $activeItemClass = '',
          $bookmarkIcon = '',
          ...
          for (var i = 0; i < data.listItems.length; i++) {
            ...
            if (data.listItems[i].name.toLowerCase().indexOf(value) == 0 && a < 5) {
              ...
              $startList +=
                ...
                feather.icons["circle"].toSvg({ class: 'me-75 ' }) +
                '<span>' +
